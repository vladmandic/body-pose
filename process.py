...
if __name__ == '__main__':
  ...
  a.add_argument('--augmentations', type=int,       default=8,   help='how many variations of detection to run')
  ...
  a.add_argument('--minconfidence', type=float,     default=0.2, help='minimum detection confidence')
  a.add_argument('--iou',           type=float,     default=0.5, help='iou threshold for overlaps')
  args = a.parse_args()
